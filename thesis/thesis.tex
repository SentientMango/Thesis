...
The smooth cone isolation method of Frixione \cite{frixione} is an alternative isolation procedure, which simplifies calculations by avoiding photon-to-hadron fragmentation contributions, treats both gluons and quarks in the same way, and can be applied to experimental data in hadron-hadron, photon-hadron and electron-positron collisions. In the Frixione method, the following isolation prescription is applied to the photon:
\begin{equation}
