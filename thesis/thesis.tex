...
\label{fig:R_scale}
\end{figure}
The correlated scale uncertainty around $R$ is lower compared to that of the individual cross sections. At 100 GeV, $R \approx 0.4 \pm 0.043$, or an uncertainty of 1\%. At high $p_T$, $R\approx 0.55 \pm 0.01$, the uncertainty is 1\%, significantly lower than the 10\% uncertainty obtained for the individual cross sections.
...
\centering
	...
	\label{fig:K_pt}
\end{figure}
The $K$-factor grows larger as a function of $p_T(V)$ for both processes. However, the difference between the two $K$-factors shrinks, due to the two processes being similar at high $p_T$. Thus, the $K$-factor uncertainty relative to $K^{(Z)}_{NLO}$, $\delta K_{NLO}/K^{(Z)}_{NLO}$, is 4\% at $p_T(V) = 500$ GeV.
...
The uncertainty is $< 1.5\%$ over the whole $p_T$ range, and is approximately 0.7\% at $p_T(V)=500$ GeV.
\vfill
...
A transfer factor $R$ is introduced as the ratio of the \ZZ cross section to the \Zg cross section, and the theoretical uncertainties upon $R$ are estimated. The uncertainties due to missing higher order corrections are 1\% at 100 GeV and 500 GeV, and do not exceed 1.5\% at even 1 TeV. Uncertainties due to parton distribution functions are 2.3\% at 100 GeV, and 1.8\% at 500 GeV. The uncertainties due to photon fragmentation effects are $<1.5\%$ in the full $p_T$ range considered, and 0.7\% at 500 GeV. 
