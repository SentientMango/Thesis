...
In this thesis, the production of the Higgs boson, in association with a $Z$ boson, as shown in Figure \ref{fig:HZ}, is considered. In this model, the Higgs boson mediates the interaction between Dark Matter particles and Standard Model particles, while the $Z$ boson decays into a lepton-antilepton pair.
