...
\subsection{MCFM}\label{subsec:MCFM}
...
Using the settings listed in Table \ref{table:default}, the cross sections for $ZZ\to ee\nu\nu$ and $Z\gamma\to ee\gamma$ are generated at LO and NLO, shown in Figure \ref{xsecs}. Throughout this analysis, these samples are used as the reference from which the transfer factor $R$ is constructed, and provide the central value around which the uncertainties are calculated.
...
Figures \ref{fig:leppt} and \ref{fig:leptony} show that the leptonically decaying $Z$ bosons have identical properties between the two processes.
...
Applying the prescription in Section \ref{sec:renorm}, the variation of scales for cross sections of $ZZ\to ee\nu\nu$ and $Z\gamma\to ee\gamma$ are shown in Figure \ref{fig:scale_xsec} below.
\begin{figure}[H]
\centering
	\begin{subfigure}{0.49\textwidth}
...
%\bibitem{gamma_jet}
%	\bibref{S. Ask, M. A. Parker, T. Sandoval, M. E. Shea, W. J. Stirling}{Using $\gamma +$ jets to calibrate the Standard Model $Z(\rightarrow \nu\nu)+$ jets background to new processes at the LHC}{Cavendish Laboratory, University of Cambridge, CB3 0HE, UK; 2011}
%{\href{[arXiv:1107.2803]}{}}
