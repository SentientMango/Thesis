...
akjnlknalknsdf
knlaknlknasdf
naskdjfklajsdklfjalksjdfkla

aksdjflkajsdklfjklasjdlfkjasd

kajsdlkfjalksdjflkasjdf
...
\begin{figure}[H]
\centering
	\includegraphics[width=0.7\textwidth]{dphi_sys.png}
	\caption{dphi(Z,V)}
\end{figure}
\begin{figure}[H]
\centering
	\includegraphics[width=0.7\textwidth]{dy_sys.png}
	\caption{dy(Z,V)}
\end{figure}
\begin{figure}[H]
\centering
	\includegraphics[width=0.7\textwidth]{y_rap.png}
	\caption{y(V)}
\end{figure}
\begin{figure}[H]
\centering
