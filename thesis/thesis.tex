...
This chapter gives an overview of the Standard Model, it's constituent matter particles, forces, and their interactions. It also delves into the shortcomings of the Standard Model, and introduces some ways in which Dark Matter is probed at the LHC. Chapter 2 describes the LHC, as well the ATLAS detector.
...
Chapter 3 discusses the theoretical aspects of investigating the \ZZ contribution, and chapter 4 presents the results obtained during the course of this thesis.
