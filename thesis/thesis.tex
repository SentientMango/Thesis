...
Thus, branching fraction of $ZZ\to \ell\ell\ell\ell$($\approx$0.46\%) compared to \ZZ (2.7\%) is about 6 times smaller. The low branching fraction of $ZZ\to \ell\ell\ell\ell$ limits the precision.
